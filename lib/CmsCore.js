...
class CmsCore {
  ...
  loadLocales() {
    ...
    this.cmsHelper.loadLocales(localesPath);
    this.cmsHelper.loadLocales(adminLocalesPath, 'adminLocales');
  }
...
module.exports = {
  ...
  loadLocales: cmsCore.loadLocales.bind(cmsCore),
  getAclResources() {
  ...
  getLocales(admin = false) {
    if (admin) {
      return cmsCore.app.adminLocales;
    }
    return cmsCore.app.locales;
  },
